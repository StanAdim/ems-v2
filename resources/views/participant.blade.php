...
@section('content')
    ...
    <div class="md:mx-auto grid grid-cols-1 gap-1 bg-primary-50 mb-10"
        style="background-image: url({{ Vite::asset('resources/images/p-hero.svg') }});background-size:cover; background-repeat:no-repeat; background-position-x: center;
            ...
            <div class="col-span-10 text-left mx-1 place-content-center">
                ...
                <div class="lg:my-64  text-center">
                    <h1 class="text-3xl md:text-5xl  font-light text-primary my-20">
                        Participate
                        in <span class="text-secondary"><br>TAIC 2024</span>
                    </h1>
