<footer class="bg-black">
    ...
    <div class="bg-brand">
        <div class="grid grid-cols-1 container mx-auto py-14 gap-8 bg-brand text-white md:grid-cols-3">
            ...
            <div class="ml-1 md:ml-auto mx-auto mt-auto text-center">
                <h4 class="mb-1 font-normal text-lg">Connect with us</h4>
    ...
    <div class="mx-auto w-full max-w-screen-2xl">
        ...
        <div class="grid grid-cols-2 gap-8 pt-8 lg:pt-10 md:grid-cols-4">
            <a href="/">
                <div class="">
        ...
        <div class="grid grid-cols-2  gap-8 px-5 py-6 lg:py-8 md:grid-cols-4">
            ...
            <div>
                ...
                <ul class="text-white font-light">
                    ...
                    <li class="">
                        <a href="/disclaimers" class="hover:underline">Disclaimer</a>
                    </li>
                </ul>
            </div>
        </div>
