    ...
    <div class="hidden w-full md:block md:w-auto px-4 py-3 container mx-auto" id="navbar-default">
        <div class="flex md:text-center md:place-content-center">
            <ul
                ...
                <li>
                    <a href="/about" class="text-white hover:underline ms-8 ">About</a>
                </li>
                {{-- <li>
                ...
                <a href="/login" class="md:hidden  text-white hover:underline">
                    Login
                </a>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div
                ...
                {{-- <button data-modal-hide="register-event-modal" type="button"
