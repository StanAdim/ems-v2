        ...
        <a href="/">
            <div class="flex divide-x-2 justify-center md:justify-start">
                <img width="74px" src="{{ Vite::asset('resources/images/white_logo.png') }}" alt=""
                    srcset="">
                <p class="px-5 place-self-center text-sm lg:text-2xl text-secondary font-medium">Events Management System
                </p>
            </div>
        </a>

        <div class="inline-flex gap-2 md:gap-4 justify-center text-nowrap py-2 lg:justify-end align-middle">
            <a href="#" class=" my-auto text-xs lg:text-xl text-secondary underline ">
                TAIC 2024
            </a>
            <a href="#" class=" my-auto text-xs lg:text-xl text-white underline ">
                Cybersecurity
            </a>
            <a href="#" class=" my-auto text-xs lg:text-xl text-white underline ">
                ICT Summit
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 container gap-2 mx-auto">
        ...
        <div class="lg:col-span-2 grid grid-cols-1 place-content-center">
            <p class="inline-flex gap-2">
                ...
                Dar es Salaam, Tanzania Julius Nyerere International Convention Centre (JNICC)
            </p>
            <p class="inline-flex gap-2">
...
<nav class="bg-brand mx-auto">
    <div class="max-w-screen-xl px-4 py-3 container mx-auto">
        <div class="flex text-center place-content-center">
            <ul class="flex flex-row overflow-hidden font-normal mt-0 space-x-8 rtl:space-x-reverse text-lg">
                <li>
                ...
                <li>
                    <a href="#" class="text-white dark:text-white hover:underline">Exhibitor</a>
                </li>
                <li>
                    <a href="#" class="text-white dark:text-white hover:underline">Sponsor</a>
                </li>
                <li>
                    <a href="#" class="text-white dark:text-white hover:underline">Buyer</a>
                </li>
                <li>
                    <a href="#" class="text-white dark:text-white hover:underline">Media</a>
                </li>
                <li>
                    <a href="#" class="text-white dark:text-white hover:underline">Help</a>
                </li>
