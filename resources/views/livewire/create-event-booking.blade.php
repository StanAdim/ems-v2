    ...
    <form wire:submit='store'>
        ...
        <div class="space-y-1 p-4 md:p-5">
            ...
            @foreach ($attendees as $index => $attendee)
                ...
                <div id="attendee-{{ $index }}" wire:key="attendee-{{ $index }}"
                    ...
                    <x-attendees-input :model="$email" placeholder="Email: karimsalmik@gmail.com"></x-attendees-input>
        ...
        <div class="m-2 my-2 grid p-2 md:mx-8 md:p-5">
            ...
            <div class="my-2 grid grid-cols-1 gap-2 lg:grid-cols-2">
                ...
                <div>
                    <label for="nationality" class="mb-1 block text-sm font-normal text-gray-500">Nationality</label>
            ...
            <div class="my-2 grid grid-cols-1 gap-2 lg:grid-cols-2">
                <div>
                    <label for="registration-status" class="mb-1 block text-sm font-normal text-gray-500">Registration
                        Status</label>
                    <select id="registration-status" autocomplete="registration-status" wire:model="registrationStatus"
                        wire:change="updateUserRegistrationStatus"
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
        ...
        <div
            ...
            <div class="place-items-end">
                ...
                <p class="text-3xl font-semibold">{{ $totalPrice }}</p>
            </div>
