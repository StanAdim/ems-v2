...
@section('content')
    <div class="container mx-auto py-10 grid grid-cols-1 lg:grid-cols-2  gap-10 md:gap-0">
        <div class="mx-2 bg-brand rounded-xl order-2 lg:order-1">
            <img class="w-full h-full p-10 object-fit  " src="{{ Vite::asset('resources/images/about.svg') }}"
                alt="" srcset="">
        </div>
        <div class="m-4 place-content-evenly lg:ml-auto rounded-xl text-lg p-2 border order-1 lg:order-2">
            <div class="grid grid-cols-1 flex-wrap gap-4 lg:m-20">
                <div class="font-semibold text-2xl lg:text-4xl mx-auto">Login to Continue</div>
                <button
                    class="border border-gray-500 place-content-center align-middle inline-flex gap-2 rounded-md xl:px-20 py-3 h-auto xl:text-xl font-semibold"
                    type="submit">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mt-4 grid grid-cols-1">
                        <x-primary-button class="bg-primary py-2 h-auto font-medium text-lg">
                            {{ __('Login') }}
                        </x-primary-button>
                    </div>
